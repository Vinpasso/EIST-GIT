...
public class MobilityServices {
  ...
  @Inject
  public MobilityServices(RentalCarApiClient rentalCarApi, TrainApiClient trainApi) {
  ...
  /**
   * Queries both {@link RentalCarAPI} and {@link TrainAPI}
  ...
  private JsonObject makeTrainApiCall(String userClass, Location sourceLoc, Location destLoc,
    ...
    /* 
     * getRentalCar API call is provided in RentalCarApiClient as
     * an example in this skeleton.
     * See RentalCarApiClient for more details
     */
    RentalCar rentalCar = rentalCarApi.getRentalCar(carClass, sourceLoc);
    
    /*
     * All the other API calls you have to make it on your own
     * For example - 
     * RentalCarTrip sourceCarTrip =
     *  rentalCarApi.rentalCarTrip(carClass, rentalCar.getCoordinates(), sourceTrainStation);
     * We are using fixed data for now in the skeleton. 
     * Hint - See solution of exercise 1 to find the parameters of each API call
     */
    RentalCarTrip sourceCarTrip = rentalCarApi.rentalCarTrip(carClass, rentalCar.getCoordinates(), sourceTrainStation);
    TrainTrip trainTrip = trainApi.trainTrip(getCabinClass(userClass), seats, sourceTrainStation, destTrainStation);
  ...
  private JsonObject makeCarApiCall(String userClass, Location sourceLoc, Location destLoc,
    ...
    /*
     * rentalCarTrip API call - you have to make it on your own
     * For example - 
 ...
 * Family - Economy
 */
public static String getCabinClass(String userClass) {
